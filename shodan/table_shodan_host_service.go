...
func tableShodanHostService(ctx context.Context) *plugin.Table {
	return &plugin.Table{
		...
		Columns: []*plugin.Column{
			...
			// TODO - convert product / version to a string using .String()?
			{Name: "product", Type: proto.ColumnType_JSON, Description: "Name of the software running the service."},
			{Name: "version", Type: proto.ColumnType_JSON, Description: "Version of the software running the service."},
